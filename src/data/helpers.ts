...
// export const getNewRound = (players: Player[]): Round =>
//   players.map((p) => {
//     return { bid: null, score: null };
//   });

// export const getEmptyScoreSheet = (players: Player[]): Scoresheet =>
//   DEALS.map((deal) => getNewRound(players));
